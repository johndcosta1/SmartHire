...
type IconName = 'dashboard' | 'users' | 'calendar' | 'shield-check' | 'briefcase' | 'user-plus' | 'cog' | 'reports' | 'logout' | 'search' | 'plus' | 'chevron-down' | 'chevron-right' | 'document-text' | 'clock' | 'check-circle' | 'x-circle' | 'exclamation-circle' | 'upload' | 'download' | 'external-link';
...
const ICONS: Record<IconName, React.ReactElement> = {
  ...
  'shield-check': <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 20.417l5.5-5.5a12.02 12.02 0 008.118-5.062z" />,
  ...
  'exclamation-circle': <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />,
